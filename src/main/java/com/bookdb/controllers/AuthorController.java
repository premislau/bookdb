...
public class AuthorController {
    ...
    public ResponseEntity<?> addBook(@PathVariable UUID authorId, @RequestBody UUID bookId) {
        try {
            return ResponseEntity.ok().body(authorService.addBookToAuthor(authorId, bookId));
